<x-app>
    ...
    <header class="mb-6 relative">
        <div class="relative">
            <img src="{{ asset('images/default-profile-banner.jpg') }}" alt="banner" class="mb-2 rounded-lg">
                ...
                {{-- @if (current_user()->is($user))
                    ...
                    @can('edit', $user)
                        ...
                        <a href="{{ $user->path('edit') }}"
                            class="rounded-full border border-grey-300 py-2 px-4 text-black text-xs mr-2">
                            Edit Profile
                        </a>
                    @endcan
